...
void setInstructionhandler(){
    ADD_HANDLER(ADD_IMM_64);ADD_HANDLER(ADD_IMM_64);ADD_HANDLER(ADD_REG_64);ADD_HANDLER(SUB_IMM_64);ADD_HANDLER(SUB_REG_64);ADD_HANDLER(MUL_IMM_64);ADD_HANDLER(MUL_REG_64);ADD_HANDLER(DIV_IMM_64);
    ADD_HANDLER(DIV_REG_64);ADD_HANDLER(OR_IMM_64);ADD_HANDLER(OR_REG_64);ADD_HANDLER(AND_IMM_64);ADD_HANDLER(AND_REG_64);ADD_HANDLER(LSH_IMM_64);ADD_HANDLER(LSH_REG_64);ADD_HANDLER(RSH_IMM_64);ADD_HANDLER(RSH_REG_64);
    ADD_HANDLER(NEG_REG_64);ADD_HANDLER(MOD_IMM_64);ADD_HANDLER(MOD_REG_64);ADD_HANDLER(XOR_IMM_64);ADD_HANDLER(XOR_REG_64);ADD_HANDLER(MOV_IMM_64);ADD_HANDLER(MOV_REG_64);ADD_HANDLER(ARSH_IMM_64);ADD_HANDLER(ARSH_REG_64);ADD_HANDLER(ADD_IMM_32);ADD_HANDLER(ADD_REG_32);
    ADD_HANDLER(SUB_IMM_32);ADD_HANDLER(SUB_REG_32);ADD_HANDLER(MUL_IMM_32);ADD_HANDLER(MUL_REG_32);ADD_HANDLER(DIV_IMM_32);ADD_HANDLER(DIV_REG_32);ADD_HANDLER(OR_IMM_32);ADD_HANDLER(OR_REG_32);ADD_HANDLER(AND_IMM_32);
    ADD_HANDLER(AND_REG_32);ADD_HANDLER(LSH_IMM_32);ADD_HANDLER(LSH_REG_32);ADD_HANDLER(RSH_IMM_32);ADD_HANDLER(RSH_REG_32);ADD_HANDLER(NEG_REG_32);ADD_HANDLER(MOD_IMM_32);ADD_HANDLER(MOD_REG_32);
    ADD_HANDLER(XOR_IMM_32);ADD_HANDLER(XOR_REG_32);ADD_HANDLER(MOV_IMM_32);ADD_HANDLER(MOV_REG_32);ADD_HANDLER(ARSH_IMM_32);ADD_HANDLER(ARSH_REG_32);ADD_HANDLER(LE_REG);ADD_HANDLER(BE_REG);
    ADD_HANDLER(LDDW);ADD_HANDLER(LDABSW);ADD_HANDLER(LDABSH);ADD_HANDLER(LDABSB);ADD_HANDLER(LDABSDW);ADD_HANDLER(LDINDW);ADD_HANDLER(LDINDH);ADD_HANDLER(LDINDB);
    ADD_HANDLER(LDINDDW);ADD_HANDLER(LDXW);ADD_HANDLER(LDXH);ADD_HANDLER(LDXB);ADD_HANDLER(LDXDW);ADD_HANDLER(STW);ADD_HANDLER(STH);ADD_HANDLER(STB);
    ADD_HANDLER(STDW);ADD_HANDLER(STXW);ADD_HANDLER(STXH);ADD_HANDLER(STXB);ADD_HANDLER(STXDW);ADD_HANDLER(JA);ADD_HANDLER(JEQ_IMM);ADD_HANDLER(JEQ_REG);
    ADD_HANDLER(JGT_IMM);ADD_HANDLER(JGT_REG);ADD_HANDLER(JGE_IMM);ADD_HANDLER(JGE_REG);ADD_HANDLER(JLT_IMM);ADD_HANDLER(JLT_REG);ADD_HANDLER(JLE_IMM);ADD_HANDLER(JLE_REG);ADD_HANDLER(JSET_IMM);
    ADD_HANDLER(JSET_REG);ADD_HANDLER(JNE_IMM);ADD_HANDLER(JNE_REG);ADD_HANDLER(JSGT_IMM);ADD_HANDLER(JSGT_REG);ADD_HANDLER(JSGE_IMM);ADD_HANDLER(JSGE_REG);
    ADD_HANDLER(JSLT_IMM);ADD_HANDLER(JSLT_REG);ADD_HANDLER(JSLE_IMM);ADD_HANDLER(JSLE_REG);ADD_HANDLER(CALL_IMM);ADD_HANDLER(EXIT);
}
